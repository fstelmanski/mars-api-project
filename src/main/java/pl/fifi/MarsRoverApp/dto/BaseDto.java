package pl.fifi.MarsRoverApp.dto;
...
public class BaseDto {
    ...
    private Boolean rememberedPreferences;
    ...
    public Boolean getRememberedPreferences() {
        return rememberedPreferences;
    }
    public void setRememberedPreferences(Boolean rememberedPreferences) {
        this.rememberedPreferences = rememberedPreferences;
    }
    @Override
    public String toString() {
        return "HomeDto [userId=" + userId + ", marsApiRoverData=" + marsApiRoverData + ", marsSol=" + marsSol
                ...
                + ", rememberPreferences=" + rememberedPreferences + "]";
    }
}
